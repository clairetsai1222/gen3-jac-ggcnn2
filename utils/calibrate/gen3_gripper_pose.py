...
def get_current_gripper_position(base, base_cyclic): 
...
def return_gripper_pose():
    ...
    with utilities.DeviceConnection.createTcpConnection(args) as router:
        ...
        try:
            cartesian_pose = get_current_gripper_position(base, base_cyclic)
