...
# 加载相机内参
intrinsic_matrix, depth_scale, color_coefficients = statical_camera_info.get_camera_intrinsics()
...
# Load a model
# yolo_model = YOLO("yolov11n.yaml")  # build a new model from scratch
# yolo_model = YOLO("yolo11n.pt")  # load a pretrained model (recommended for training)
yolo_model = YOLO("models_weight/yolov10x.pt")
...
try:
    while stop_flag:
        # 等待下一帧
        _, depth_image, color_image, depth_intrinsic, color_intrinsic = dc.get_frame()
